...
val extract_requires : string -> (string with_loc list * string with_loc list, Mach_error.t) result

(** Extract #require directives from a source file, raises on error *)
val extract_requires_exn : string -> string with_loc list * string with_loc list
